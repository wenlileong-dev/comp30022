...
const testAllContacts = [
    { name: "contact1", contactTime: 2021-09-21, userID: '614d7378de23b63284235ab6' },
    { name: "contact2", contactTime: 2021-09-22, userID: '614d7378de23b63284235ab6'  },
    { name: "contact3", contactTime: 2021-09-23, userID: '614d7378de23b63284235ab6'  },
    { name: "contact4", contactTime: 2021-09-24, userID: '614d7378de23b63284235ab6'  },
    ...
    it('should return recent contacts', function (done) {
        ...
        for(i=0;i<testAllContacts.length;i++){
            if(testAllContacts[i].userID===userID){
                result.push({name:testAllContacts[i].name,contactTime:testAllContacts[i].contactTime})
            }
        }
        if(result.length>5){
            result=result.sort(({contactTime:a},{contactTime:b})=>a-b).slice(0,5);
        }else{
